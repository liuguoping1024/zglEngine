...
#ifndef __zgl_prim_2d_h__
#define __zgl_prim_2d_h__
...
/**
 * @brief The Primitives which will be mapped by the parellal projection.
 * 平行投影
 */
class zglPrim2D: public zglPrim
{
public:
	zglPrim2D();

	/**
	 * Initialize the Primitive-2D, the procedure is list below:
	 * 1. Initialize the Prim2D's parameter;
...
protected:
	...
	/**
	 * Render the 2D objects to the screen.
	 */
	virtual void render();
